...
async def send_success(
    ...
    try:
        ...
        return {
            "success": success,
            "type": "success",
            "message": "Success notification sent" if success else "Failed to send success notification"
        }
    except Exception as e:
        raise HTTPException(status_code=500, detail=f"Failed to send success notification: {e}")
...
async def send_error(
    ...
    try:
        ...
        return {
            "success": success,
            "type": "error",
            "message": "Error notification sent" if success else "Failed to send error notification"
        }
    except Exception as e:
        raise HTTPException(status_code=500, detail=f"Failed to send error notification: {e}")
...
async def send_warning(
    ...
    try:
        ...
        return {
            "success": success,
            "type": "warning",
            "message": "Warning notification sent" if success else "Failed to send warning notification"
        }
    except Exception as e:
        raise HTTPException(status_code=500, detail=f"Failed to send warning notification: {e}")
...
async def send_info(
    ...
    try:
        ...
        return {
            "success": success,
            "type": "info",
            "message": "Info notification sent" if success else "Failed to send info notification"
        }
    except Exception as e:
        raise HTTPException(status_code=500, detail=f"Failed to send info notification: {e}")
