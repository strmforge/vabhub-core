...
from .subscription_manager import SubscriptionManager, Subscription, SubscriptionRule, SubscriptionStatus, MediaType
    ...
    try:
        ...
        for subscription in subscriptions:
            result.append({
                ...
                "next_check": subscription.next_check.isoformat() if subscription.next_check else None,
                "created_at": subscription.created_at.isoformat(),
...
async def update_subscription(
    ...
    try:
        ...
        # 更新订阅
        updated_subscription = await manager.update_subscription(subscription_id, **update_data)
