...
class Config:
    ...
    SPOTIFY_CLIENT_ID = _unified_config.api.spotify_client_id or os.getenv("SPOTIFY_CLIENT_ID", "")
    SPOTIFY_CLIENT_SECRET = _unified_config.api.spotify_client_secret or os.getenv("SPOTIFY_CLIENT_SECRET", "")
