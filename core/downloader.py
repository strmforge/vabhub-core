...
class DownloaderManager:
    ...
    async def test_qbittorrent_connection(self, url: str, username: str = "", password: str = "") -> Dict[str, Any]:
        """Test connection to qBittorrent"""
        try:
            # First, login if credentials provided
            if username and password:
                login_data = {"username": username, "password": password}
                login_response = await self.client.post(f"{url}/api/v2/auth/login", data=login_data)
    ...
    async def test_transmission_connection(self, url: str, username: str = "", password: str = "") -> Dict[str, Any]:
        ...
        try:
            ...
            response = await self.client.post(f"{url}/transmission/rpc", json=rpc_data, headers=headers)
    ...
    async def test_connection(self, url: str, downloader_type: str, username: str = "", password: str = "") -> Dict[str, Any]:
        ...
        if downloader_type.lower() == "qbittorrent":
            ...
            return {"ok": False, "error": f"Unsupported downloader type: {downloader_type}"}
    
    async def get_qbittorrent_stats(self, url: str, username: str = "", password: str = "") -> Dict[str, Any]:
    ...
    async def get_transmission_stats(self, url: str, username: str = "", password: str = "") -> Dict[str, Any]:
    ...
    async def get_stats(self, url: str, downloader_type: str, username: str = "", password: str = "") -> Dict[str, Any]:
    ...
    async def add_qbittorrent_torrent(self, url: str, torrent_url: str, username: str = "", password: str = "") -> Dict[str, Any]:
        ...
        try:
            ...
            response = await self.client.post(f"{url}/api/v2/torrents/add", data=add_data)
    ...
    async def add_transmission_torrent(self, url: str, torrent_url: str, username: str = "", password: str = "") -> Dict[str, Any]:
    ...
    async def add_torrent(self, url: str, downloader_type: str, torrent_url: str, username: str = "", password: str = "") -> Dict[str, Any]:
        """Add torrent to downloader"""
        if downloader_type.lower() == "qbittorrent":
            return await self.add_qbittorrent_torrent(url, torrent_url, username, password)
        elif downloader_type.lower() == "transmission":
            return await self.add_transmission_torrent(url, torrent_url, username, password)
        else:
            return {"ok": False, "error": f"Unsupported downloader type: {downloader_type}"}
