...
description="检测HNR风险")
    ...
    @strawberry.field
description="获取种子列表")
    async def torrents(self, hashes: Optional[List[str]] = None) -> List[TorrentInfoType]:
...
description="创建站点包")
    ...
    @strawberry.mutation
description="更新站点包")
    async def update_site_bundle(self, id: str, input: SiteBundleUpdateInput) -> SiteBundleType:
        from .site_bundle_manager import site_bundle_manager
