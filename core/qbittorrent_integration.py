...
class QBittorrentIntegration:
    ...
    async def add_torrent(self, torrent_file: bytes = None, 
        ...
        try:
            ...
            if torrent_file:
                data.add_field('torrents', torrent_file, 
            ...
            async with self.session.post(f"{self.base_url}/api/v2/torrents/add", 
                                       data=data, cookies=self.cookies) as response:
    ...
    async def get_torrents(self, hashes: List[str] = None) -> List[TorrentInfo]:
        ...
        try:
            ...
            async with self.session.get(f"{self.base_url}/api/v2/torrents/info", 
                                      params=params, cookies=self.cookies) as response:
                if response.status == 200:
    ...
    async def set_torrent_tags(self, hashes: List[str], tags: List[str]):
        ...
        try:
            ...
            async with self.session.post(f"{self.base_url}/api/v2/torrents/addTags", 
                                       data=data, cookies=self.cookies) as response:
                return response.status == 200
        except Exception as e:
    ...
    async def set_torrent_category(self, hashes: List[str], category: str):
        ...
        try:
            ...
            async with self.session.post(f"{self.base_url}/api/v2/torrents/setCategory", 
                                       data=data, cookies=self.cookies) as response:
                return response.status == 200
        except Exception as e:
    ...
    async def set_upload_limit(self, hashes: List[str], limit: int):
        ...
        try:
            ...
            async with self.session.post(f"{self.base_url}/api/v2/torrents/setUploadLimit", 
                                       data=data, cookies=self.cookies) as response:
                return response.status == 200
        except Exception as e:
    ...
    async def set_download_limit(self, hashes: List[str], limit: int):
        ...
        try:
            ...
            async with self.session.post(f"{self.base_url}/api/v2/torrents/setDownloadLimit", 
                                       data=data, cookies=self.cookies) as response:
                return response.status == 200
        except Exception as e:
    ...
    async def pause_torrents(self, hashes: List[str]):
        ...
        try:
            ...
            async with self.session.post(f"{self.base_url}/api/v2/torrents/pause", 
                                       data=data, cookies=self.cookies) as response:
                return response.status == 200
        except Exception as e:
    ...
    async def resume_torrents(self, hashes: List[str]):
        ...
        try:
            ...
            async with self.session.post(f"{self.base_url}/api/v2/torrents/resume", 
                                       data=data, cookies=self.cookies) as response:
                return response.status == 200
        except Exception as e:
    ...
    async def delete_torrents(self, hashes: List[str], delete_files: bool = False):
        ...
        try:
            ...
            async with self.session.post(f"{self.base_url}/api/v2/torrents/delete", 
                                       data=data, cookies=self.cookies) as response:
                return response.status == 200
        except Exception as e:
    ...
    async def get_categories(self) -> Dict[str, Any]:
        """获取分类列表"""
        try:
            async with self.session.get(f"{self.base_url}/api/v2/torrents/categories", 
    ...
    async def get_tags(self) -> List[str]:
        """获取标签列表"""
        try:
            async with self.session.get(f"{self.base_url}/api/v2/torrents/tags", 
                                      cookies=self.cookies) as response:
                if response.status == 200:
                    data = await response.json()
                    return data
    ...
    async def create_category(self, name: str, save_path: str):
        ...
        try:
            ...
            async with self.session.post(f"{self.base_url}/api/v2/torrents/createCategory", 
                                       data=data, cookies=self.cookies) as response:
                return response.status == 200
        except Exception as e:
    ...
    async def get_transfer_info(self) -> Dict[str, Any]:
        """获取传输信息"""
        try:
            async with self.session.get(f"{self.base_url}/api/v2/transfer/info", 
                                      cookies=self.cookies) as response:
                if response.status == 200:
                    return await response.json()
                else:
