...
class STRMGatewayManager:
    ...
    def organize_strm_files(self, organization_rules: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            for strm_file in strm_files:
                ...
                if any(keyword in filename for keyword in ['season', 's0', 'episode', 'e0']):
    ...
    def batch_generate_strm_files(self, media_list: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        logger.info(f"Batch generated STRM files: {len(results['success'])} success, {len(results['failed'])} failed")
        return results
            ...
            for strm_file in strm_files:
                ...
                if file_age > max_age_seconds:
                    try:
                        ...
                        logger.error(f"Failed to remove old STRM file {strm_file['path']}: {e}")
