...
class TestRedisCacheManager:
    ...
    async def test_cache_pattern_matching(self, cache_manager):
        ...
        cache_manager.redis.keys.return_value = [b"chart_tmdb_US_week_movie_123", b"chart_tmdb_US_week_tv_456"]
    ...
    async def test_bulk_operations(self, cache_manager):
        ...
        cache_manager.redis.pipeline.return_value.__aenter__.return_value = mock_pipeline
