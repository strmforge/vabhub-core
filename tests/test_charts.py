...
class TestChartsService:
    ...
    @pytest.mark.asyncio
    async def test_fetch_external_charts_success(self, charts_service, mock_httpx_client):
    ...
    @pytest.mark.asyncio
    async def test_fetch_external_charts_failure(self, charts_service, mock_httpx_client):
    ...
    async def test_validate_chart_parameters(self, charts_service):
        ...
        # Test invalid source
        assert charts_service.validate_parameters("invalid", "US", "week", "movie") is False
        
        # Test invalid region
        assert charts_service.validate_parameters("tmdb", "XX", "week", "movie") is False
        
        # Test invalid time range
        assert charts_service.validate_parameters("tmdb", "US", "invalid", "movie") is False
        
        # Test invalid media type
        assert charts_service.validate_parameters("tmdb", "US", "week", "invalid") is False
