...
class TestDatabaseManager:
    ...
    async def test_database_initialization(self, database_manager):
        ...
        expected_tables = [
            'users', 'subscriptions', 'tasks', 'charts_data', 
            'chart_items', 'media_servers', 'downloaders'
        ]
    ...
    async def test_subscription_crud_operations(self, database_manager):
        ...
        success = await database_manager.update_subscription(subscription_id, update_data)
        assert success is True
